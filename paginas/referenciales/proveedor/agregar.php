<div class="container mt-4">
  ...
  <div class="card border-0 bg-light p-3 shadow-sm rounded-4">
    <div class="card-header bg-transparent border-0 pb-0">
      <h4 class="mb-3 text-secondary fw-bold"><i class="bi bi-shop me-2"></i>Agregar / Editar Proveedor</h4>
    </div>
    <div class="card-body p-0">
      <div class="row g-4">
        <div class="col-md-6">
          <div class="form-floating">
            <input type="text" id="razon_txt" class="form-control form-control-custom" placeholder="Nombre o empresa">
            <label for="razon_txt"><i class="bi bi-shop-window me-1"></i>Razón Social</label>
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-floating">
        ...
        <div class="col-md-6">
          <div class="form-floating">
            ...
            <label for="telefono_txt"><i class="bi bi-telephone me-1"></i>Teléfono</label>
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-floating">
    ...
    <div class="card-footer bg-transparent border-0 text-end pt-3">
      <button class="btn btn-primary me-2" onclick="guardarProveedor(); return false;">
        <i class="bi bi-save-fill me-1"></i>Guardar
      </button>
      <button class="btn btn-outline-secondary" onclick="mostrarListarProveedor(); return false;">
