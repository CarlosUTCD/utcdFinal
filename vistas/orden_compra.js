...
function renderTablaOrden(arr){
    ...
    arr.forEach(function(o){
        tbody.append(`<tr>
            ...
            <td>
                <button class="btn btn-warning btn-sm editar-orden" data-id="${o.id_orden}" title="Editar">Editar</button>
                <button class="btn btn-danger btn-sm eliminar-orden" data-id="${o.id_orden}" title="Eliminar">Eliminar</button>
            </td>
        </tr>`);
    });
}
